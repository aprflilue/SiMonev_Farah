    ...
    <div class="card card-primary shadow mb-4">
        <div class="col-lg-10">
            ...
            <div class="card-body mt-3">
                    ...
                    <form ID="form-vertical" class="form-horizontal form-wizard-wrapper" action="/dashboard/uph/update/{{ $id }}" method="post" novalidate enctype="multipart/form-data">   
                        @csrf
                        @method('PUT')
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="nama" name="nama" type="text" class="form-control @error('nama') is-invalid @enderror"  value="{{ old('nama' , $uph->nama) }}" autofocus>
                                @error('nama') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Alamat</label>
                                <input id="alamat" name="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror"  value="{{ old('alamat', $uph->alamat) }}" autofocus>
                                @error('alamat') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="mb-3">
                                <label for="provinsi" class="form-label">Provinsi</label>
                                <select class="form-control" id="provinsi" name="provinsi_id" value="{{ old('provinsi_id', $uph->provinsi_id) }}" required>
                                    {{-- <option>Pilih Provinsi.....</option> --}}
                                    <option style="background-color: rgb(180, 180, 180)" value="{{ old('provinsi_id', $uph->provinsi_id) }}" selected>-- {{ old('provinsi_id', $uph->provinsi_name) }} --</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="kabupaten" name="kabupaten_id" value="{{ old('kabupaten_id'), $uph->kabupaten_name}}" required>
                                    <option style="background-color: rgb(180, 180, 180)" value="{{ old('kabupaten_id', $uph->kabupaten_id) }}" selected>-- {{ old('kabupaten_id', $uph->kabupaten_name) }} --</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="kecamatan">Kecamatan</label>
                                <select class="form-control" id="kecamatan" name="kecamatan_id" value="-- 'kecamatan_id', $uph->kecamatan_name) }}" required>
                                    <option style="background-color: rgb(180, 180, 180)" value="{{ old('kecamatan_id', $uph->kecamatan_id) }}" selected>-- {{ old('kecamatan_id', $uph->kecamatan_name) }} --</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="desa">Kelurahan/Desa</label>
                                <select class="form-control" id="desa" name="desa_id" value="{{ old('desa_id', $uph->desa_name) }}" required>
                                    <option style="background-color: rgb(180, 180, 180)" value="{{ old('desa_id', $uph->desa_id) }}" selected>-- {{ old('desa_id', $uph->desa_name) }} --</option>
                                </select>
                            </div>
                        ...
                        <fieldset>
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="komoditi" name="komoditi" value="{{ old('komoditi') }}" required>
                                    <option style="background-color: rgb(180, 180, 180)" value="{{ old('komoditi', $uph->komoditi) }}" selected>--{{ old('komoditi', $uph->komoditi) }}--</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="banper" name="banper" type="text" class="form-control @error('banper') is-invalid @enderror"  value="{{ old('banper', $uph->banper) }}" autofocus>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input id="tahun_bantuan" name="tahun_bantuan" type="text" class="form-control @error('tahun_bantuan') is-invalid @enderror"  value="{{ old('tahun_bantuan', $uph->tahun_bantuan) }}" autofocus>
                                </div>
                            ...
                            <label for="jenis_bantuan" class="form-label">Jenis Bantuan</label>
                                <select class="form-control" id="jenis_bantuan" name="jenis_bantuan" value="{{ old('jenis_bantuan') }}" readonly>
                                    <option style="background-color: rgb(180, 180, 180)" value="{{ old('jenis_bantuan', $uph->jenis_bantuan) }}" selected>{{ old('jenis_bantuan', $uph->jenis_bantuan) }}</option>
                            ...
                            <br>
                            <a href="/dashboard/uph" type="submit" class="btn mt-2" style="background-color: #bfc6cd">Cancel</a>
