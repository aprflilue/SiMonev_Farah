...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Input TP</div>
      </div>
    </div>
</section>
    ...
    <div class="card card-primary shadow mb-4">
        <div class="col-lg-10">
            ...
            <div class="card-body mt-3">
                    ...
                    <form class="form-horizontal form-wizard-wrapper" action="/dashboard/tp/store/{{ $id }}" method="post" novalidate enctype="multipart/form-data">   
                        @csrf
                        @method('PUT')
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch ml-2 mr-3">
                                                <input type="checkbox" class="custom-control-input" name="proposal" id="proposal" value="{{ old('proposal', isset($tp) ? 'checked' : '') }}">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch ml-2 mr-3">
                                                <input type="checkbox" class="custom-control-input" name="eproposal" id="eproposal" value="{{ old('eproposal', isset($tp) ? 'checked' : '') }}">
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch ml-2 mr-3">
                                                <input type="checkbox" class="custom-control-input" name="uji_lab" id="uji_lab" value="{{ old('uji_lab', isset($tp) ? 'checked' : '') }}">
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch ml-2 mr-3">
                                                <input type="checkbox" class="custom-control-input" name="pengajuan_sertif" id="pengajuan_sertif" value="{{ old('pengajuan_sertif', isset($tp) ? 'checked' : '') }}">
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch ml-2 mr-3">
                                                <input type="checkbox" class="custom-control-input" name="foodgrade" id="foodgrade" value="{{ old('foodgrade', isset($tp) ? 'checked' : '') }}">
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch ml-2 mr-3">
                                                <input type="checkbox" class="custom-control-input" name="test_report" id="test_report" value="{{ old('test_report', isset($tp) ? 'checked' : '') }}">
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input id="cpcl" name="cpcl" type="file" class="dropify @error('cpcl') is-invalid @enderror">
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="sk_penetapan" name="sk_penetapan" @error('sk_penetapan') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="workshop" name="workshop" @error('workshop') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="spk" name="spk" @error('spk') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="status_lahan" name="status_lahan" @error('status_lahan') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="penyusunan_sop" name="penyusunan_sop" @error('penyusunan_sop') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="bast_sarana" name="bast_sarana" @error('bast_sarana') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="bast_prasarana" name="bast_prasarana" @error('bast_prasarana') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="foto_pop" name="foto_pop" @error('foto_pop') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="foto_bimtek" name="foto_bimtek" @error('foto_bimtek') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="laporan_bimtek" name="laporan_bimtek" @error('laporan_bimtek') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="foto_produksi" name="foto_produksi" @error('foto_produksi') is-invalid @enderror>
                                    ...
                                    <div class="col-6 mt-2">
                                        <div class="mb-3">
                                            ...
                                            <input class="dropify" type="file" id="surat_bebas_hukum" name="surat_bebas_hukum" @error('surat_bebas_hukum') is-invalid @enderror>
