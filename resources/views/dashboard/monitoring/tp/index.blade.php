            ...
            <div class="col-xl-12">
                <div class="card card-primary shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Data Monitoring TP</h6>
                        {{-- <a href="/dashboard/tp/create" class="btn btn-icon icon-left btn-primary"><span class="icon text-white-50"><i class="fas fa-plus"></i></span><span class="text">Input Data</span></a> --}}
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                                    ...
                                    @if( $data_kelompok->status != null )
                                        ...
                                        <td>
                                            <div class="btn-group mb-1" role="group" aria-label="Basic example">
                                                <a href="/dashboard/tp/{{ $data_kelompok->id }}/edit" class="btn btn-icon btn-sm btn-warning"><i class="far fa-edit"></i></a>&nbsp;
                                                <form action="/dashboard/tp/{{ $data_kelompok->tp_id }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="submit" class="btn btn-icon btn-sm btn-danger " onclick="return confirm('Apakah anda yakin untuk menghapus Data Monitoring TP?')"><i class="fas fa-trash"></i></button>
                                                </form>
                                            </div>
                                        </td>
                                    @else
                                        ...
                                        <td>
                                            <div class="btn-group mb-1" role="group" aria-label="Basic example">
                                                <a href="/dashboard/tp/{{ $data_kelompok->id }}/create" class="btn btn-icon btn-sm btn-info"><i class="fas fa-plus"></i></a>&nbsp;
                                            </div>
                                        </td>
                                    @endif
                                </tr>
