        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align: left;">
                <form action="/dashboard/admin" method="post">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Provinsi <small class="text-danger"> *</small></label>
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Username <small class="text-danger"> *</small></label>
