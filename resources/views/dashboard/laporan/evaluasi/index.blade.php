            ...
            <div class="col-xl-12">
                <div class="card card-primary shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Data Laporan Evaluasi</h6>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-stripped table-bordered display" id="evaluasi">
                                ...
                                <tr>
                                    ...
                                    @if($data_kelompok->status != null)
                                        ...
                                        <td class="text-center">
                                            <a href="/dashboard/laporan_evaluasi/{{ $data_kelompok->kelompok_id }}/show" class="btn btn-icon btn-sm btn-secondary"><i class="far fa-eye"></i></a>&nbsp;
                                        </td>
                                        
                                    @else
                                        <td class="text-center"><div class="text-small font-weight-600 text-muted"><i class="fas fa-circle" style="font-size: 9px"></i> Belum Diisi </div></td>
                                        <td><div>--Belum Diisi--</td>                                    
                                        <td></td>
                                    @endif
...

                {
                    ...
                    customize: function (win) {
                        $(win.document.body)
                            ...
                            .prepend(
                                '<h4 style="text-align:center; padding-top:20px ; padding-bottom:10px">Data Laporan Evaluasi</h4>'
                            )
                            .prepend(
